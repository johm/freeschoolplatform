...
class CourseRegistrationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create course_registration" do
    assert_difference('CourseRegistration.count') do
      post course_registrations_url, params: { course_registration: { course_id: @course_registration.course_id, user_id: @course_registration.user_id } }
    end
  ...
  test "should update course_registration" do
    patch course_registration_url(@course_registration), params: { course_registration: { course_id: @course_registration.course_id, user_id: @course_registration.user_id } }
